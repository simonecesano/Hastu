...
sub _google {
    ...
    return Net::Google::DataAPI::Auth::OAuth2->new({
        ...
        scope => ['https://www.google.com/calendar/feeds/', 'https://www.googleapis.com/auth/plus.login', 'https://www.googleapis.com/auth/email', 'https://www.googleapis.com/auth/profile'],
